...
(The script will run a check of the argument, to make sure the chromosome name is in the format, starting position does not exceed the length of the chromosome)
